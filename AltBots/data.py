...
RAID = [
    ...
    "GOD FATHER 𝗧𝗘𝗥𝗔 𝗣𝗘𝗛𝗟𝗔 𝗕𝗔𝗔𝗣 𝗛𝗨 𝗠𝗔̂𝗔̂𝗗𝗔𝗥𝗖𝗛Ø𝗗 ",
...
MRAID = [
    ...
    "TUMHARE KABIL HU YA",
    "TUMHARE KABIL NHI😂💓",
    "AND EK AUR BAAT BOLNI THI KI MERA OWNER KO DM KARO I LOVE YOU BOLNA @ll_YOUR_FATHER_HU_ll😙😙",
...
SRAID = [
    ...
    "तड़प कर यह मुझे दर्द दे रही है @ll_YOUR_FATHER_HU_ll😌😌",
